    ...
    for (it_t = 1; it_t < deg2inx(it_max) + 1; it_t *= 2)
    {
        for (it_sp = 1; it_sp < deg2inx(it_max) + 1; it_sp *= 2)
        {
            ...
            if (SMOOTH_SOLUTION == 1) {
                ...
                //residual_Ch_Sokol(V1, V2, G, p_s, &n_s, u1, u2, g);
                nc_v1[k] = n_s.V1norm;
                nc_v2[k] = n_s.V2norm;
                nc_g[k] = n_s.Gnorm;

                residual_L2h(V1, V2, P, p_s, &n_s, u1, u2, g);
                //residual_L2h_Sokol(V1, V2, G, p_s, &n_s, u1, u2, g);
                nl2_v1[k] = n_s.V1norm;
                nl2_v2[k] = n_s.V2norm;
                nl2_g[k] = n_s.Gnorm;

                residual_W12(V1, V2, P, p_s, &n_s, u1, u2, g);
                //residual_W12_Sokol(V1, V2, G, p_s, &n_s, u1, u2, g);
